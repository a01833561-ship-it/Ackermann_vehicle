...
rviz-> make an empty file in the launch order  then download from canvas
...
ros2 run roz_gz_bridge parameter_bridge 

config_file:=home/sina/Workspaces/sm26_ws/src/ackerman26_vehicle_description/config/ros_bridge.yaml
